package com.uda.examplestemp.config;
...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", transactionManagerRef = "transactionManager", basePackages = {"com.uda.examplestemp"})
public class ExampleDBConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder, @Qualifier("dataSource") DataSource dataSource) {
        ...
        LocalContainerEntityManagerFactoryBean factory = builder
                ...
                .packages("com.uda.examplestemp.model")
