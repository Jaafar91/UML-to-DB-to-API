...
public class ${ROUTE_NAME_CAPITALIZE}Controller {
    ...
    public ResponseEntity<GenericResponse> updateOne(@PathVariable("${ROUTE_UNIQUE}") ${ROUTE_UNIQUE_DATATYPE} ${ROUTE_UNIQUE},@RequestBody ${SINGLE_ROUTE_NAME_CAPITALIZE} ${SINGLE_ROUTE_NAME}) {
